...
VALUES (@OGUID+610, 190610, 532, 0, 0, 1, 1, -11083.367, -1972.86, 77.576, 3.11328, 0, 0, 0, 0, 120, 100, 1, 0, 'gobject_ipp_si');

UPDATE `creature` SET `phaseMask` = @IPPPHASE WHERE `id1` = 28194; -- Prince Tenris Mirkblood, IPPPHASE 65536
