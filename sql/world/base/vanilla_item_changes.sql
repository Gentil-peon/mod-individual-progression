...
UPDATE `item_template` SET `AllowableClass` = 128 WHERE (`entry` = 22589);
UPDATE `item_template` SET `AllowableClass` = 256 WHERE (`entry` = 22630);
UPDATE `item_template` SET `AllowableClass` = 16 WHERE (`entry` = 22631);
UPDATE `item_template` SET `AllowableClass` = 1024 WHERE (`entry` = 22632);
